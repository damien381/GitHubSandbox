#####################################################################
###   TMGet-DatabaseDocumentationToHTML.ps1                       ###
###   By: Adam Hoge - Trapeze Project Engineer                    ###
###   This is a script to help me gather Database information     ###
...
$filePath = "C:\TM_Backup\database_documentation\";
...
$sql_server = New-Object Microsoft.SqlServer.Management.Smo.Server $SQLServerName;
