...
#I can't have two folders with the same name in this backup.
#I will delete this dir in the end.
copy-item -path "C:\ProgramData\TransitMaster\" "C:\temp\ProgData_Transitmaster" -recurse

#Variables, only Change here
$Destination="C:\TM_Backup" #Copy the Files to this Location
...
remove-item "C:\temp\ProgData_Transitmaster" -force -Recurse
